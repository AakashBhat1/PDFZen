...
const toolInitializers = {
  ...
  'pdf-to-word': () => import('./tools/convert.js').then(m => m.initPdfToWord),
  'word-to-pdf': () => import('./tools/convert.js').then(m => m.initWordToPdf),
  'pdf-to-powerpoint': () => import('./tools/convert.js').then(m => m.initPdfToPowerpoint),
  'powerpoint-to-pdf': () => import('./tools/convert.js').then(m => m.initPowerpointToPdf),
  'pdf-to-excel': () => import('./tools/convert.js').then(m => m.initPdfToExcel),
  'excel-to-pdf': () => import('./tools/convert.js').then(m => m.initExcelToPdf),
  'pdf-to-jpg': () => import('./tools/convert.js').then(m => m.initPdfToJpg),
  'jpg-to-pdf': () => import('./tools/convert.js').then(m => m.initJpgToPdf),
  'pdf-to-markdown': () => import('./tools/convert.js').then(m => m.initPdfToMarkdown),
  'html-to-pdf': () => import('./tools/convert.js').then(m => m.initHtmlToPdf),
